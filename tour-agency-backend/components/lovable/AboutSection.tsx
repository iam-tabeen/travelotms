          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="rounded-3xl overflow-hidden h-48 shadow-lg transform hover:scale-[1.02] transition-transform">
                  <img src="/mountains.jpg" alt="Mountain landscape" className="w-full h-full object-cover" />
                </div>
                <div className="rounded-3xl overflow-hidden h-64 shadow-lg transform hover:scale-[1.02] transition-transform">
