...
import WhatsAppButton from '@/components/WhatsAppButton'; // <-- 1. Imported the new button
...
export const metadata: Metadata = {
  title: "Axius Digital Tour CRM",
  description: "White-label tour agency management system",
};
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ClerkProvider>
      <html lang="en">
        <body
          className={`${geistSans.variable} ${geistMono.variable} ${poppins.variable} ${montez.variable} antialiased`}
          style={globalTheme}
        ...
        >
          ...
          {/* 2. Added the WhatsApp Button and passed the dynamic phone number! */}
          <WhatsAppButton />
