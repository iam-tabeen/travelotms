...
// 1. THE FIX: Accept the new fixedDate prop here
export default function TourClient({ tour, fixedDate }: { tour: any; fixedDate?: string }) {
                            ...
                            {['overview', 'itinerary', 'inclusions', 'policy'].map((tab) => (
                                <button
                                    ...
                                    className={`flex-1 min-w-[120px] py-3 px-4 rounded-xl text-sm font-bold capitalize transition-all ${activeTab === tab
                                        ? 'bg-axius-theme-primary text-white shadow-md'
                                        ...
                                        {tour.itineraryDays.map((day: any, index: number) => {
                                            ...
                                            return (
                                                <div key={day.id} className="relative flex gap-6">
                                                    ...
                                                    {/* The Day Number Box */}
                                                    <div
                                                        className="relative z-10 w-12 h-12 bg-[#FBFDFF] border-2 rounded-2xl flex items-center justify-center font-black text-lg shadow-lg flex-shrink-0 transition-colors"
                                                        style={{
                            ...
                            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                                ...
                                <div className="space-y-4">
                                    {tour.bookingMode !== 'WHATSAPP' && (
                                        // 2. THE FIX: Pass fixedDate down into the BookingForm component
                                        <BookingForm tourId={tour.id} tenantId={tour.tenantId} basePrice={tour.basePrice} fixedDate={fixedDate} />
                                    )}
