...
export default function AddTourForm() {
  ...
  return (
    <main className="min-h-screen bg-[#F0F2F7] py-12 px-6 sm:px-12 lg:px-24 transition-colors duration-300 add-bg-main">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 transition-colors add-bg-card">
          <div className="mb-10">
            <h1 className="text-3xl font-black text-axius-secondary add-text-primary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "28px" }}>Add New Tour</h1>
          </div>
          ...
          <form action={createTour} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-gray-50 border border-gray-100 rounded-2xl transition-colors add-bg-muted add-border-subtle">
              <h2 className="md:col-span-2 text-lg font-black text-axius-secondary border-b border-gray-200 pb-2 uppercase tracking-wider add-text-primary add-border-subtle" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "18px" }}>
                1. Basic Information
              </h2>

              <div className="md:col-span-2">
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Tour Title</label>
              ...
              {/* Cover Image Field */}
              <div className="md:col-span-2">
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Cover Image (Main Thumbnail)</label>
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Gallery Images (Slider)</label>
                ...
                <div className="p-4 border-2 border-dashed border-gray-300 rounded-xl bg-white transition-colors add-bg-main add-border-subtle">
                  <input
                    ...
                    className="mb-4 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-black file:uppercase file:bg-gray-900 file:text-white hover:file:bg-gray-800 file:cursor-pointer disabled:opacity-50 cursor-pointer add-file-input add-text-secondary"
                  />
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Destination</label>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Base Price (Rs.)</label>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Duration</label>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Transport</label>
                <select name="transportType" required defaultValue="Car" className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-axius-secondary placeholder-gray-400 outline-none bg-white font-bold transition-colors add-input">
              ...
              <div className="space-y-4 pt-0 md:col-span-2">
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Departure Schedule</label>

                <select
                  name="departureType"
                  value={departureType}
                  onChange={(e) => setDepartureType(e.target.value)}
                  className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-axius-secondary placeholder-gray-400 outline-none bg-white font-bold transition-colors add-input"
                >
                ...
                {departureType === 'CLIENT_CHOICE' && (
                  <div className="mt-4 p-5 bg-red-50 border border-red-100 rounded-xl transition-colors add-bg-red-soft">
                    ...
                    <p className="text-xs text-red-600 font-medium mb-4 add-text-secondary">
                      Select dates when this tour is unavailable (e.g., guide is booked, fully sold out). You can add as many dates as you need.
                    </p>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Accommodation</label>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Booking Mode</label>
            ...
            <div className="p-6 bg-gray-50 border border-gray-100 rounded-2xl space-y-6 transition-colors add-bg-muted add-border-subtle">
              <h2 className="text-lg font-black text-axius-secondary border-b border-gray-200 pb-2 uppercase tracking-wider add-text-primary add-border-subtle" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "20px" }}>
                2. Tour Details & Policy
              </h2>

              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Overview / Description</label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
                <div>
                  <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Inclusions (One per line)</label>
                ...
                <div>
                  <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Exclusions (One per line)</label>
              ...
              <div>
                <label className="block text-xs font-black text-axius-secondary uppercase tracking-widest mb-2 add-text-secondary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "14px" }}>Tour Policy / Terms</label>
            ...
            {/* SECTION 3: ITINERARY */}
            <div className="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm mt-16 transition-colors add-bg-card add-border-subtle">
              <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-4 add-border-subtle">
                <h2 className="text-lg font-black text-axius-secondary uppercase tracking-wider add-text-primary" style={{ fontFamily: 'var(--font-poppins)', fontWeight: "700", fontSize: "24px" }}>3. Day-by-Day Itinerary</h2>
                <div>
            ...
            {/* SECTION 4: ADD-ONS */}
            <div className="p-6 bg-blue-50 border border-blue-100 rounded-2xl transition-colors add-bg-blue-soft">
              ...
              <div className="flex gap-3 mb-4 ">
                <input 
                  ...
                  className="flex-1 w-32 p-3 border rounded-xl outline-none transition-colors add-input" 
                />
                <input 
                  type="number" 
                  placeholder="Price" 
                  ...
                  className="w-32 p-3 border rounded-xl outline-none transition-colors add-input" 
                />
