    ...
    <main className="min-h-screen bg-gray-50 p-6 md:p-10 transition-colors duration-300 set-bg-main">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 flex justify-between items-center px-4">
          <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-gray-900 set-text-primary">Agency Settings</h1>
          <Link href="/dashboard" className="text-xs font-black text-gray-400 hover:text-gray-900 tracking-widest uppercase transition-colors set-text-secondary bg-white dark:bg-slate-800 px-4 py-2 rounded-full shadow-sm">
            ⬅ Dashboard
          </Link>
        </div>
