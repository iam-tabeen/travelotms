...
import ContactForm from '@/components/ContactForm'; // <-- 1. Import it here!
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1 space-y-10">
            {/* ... Keep your exact Left Column code here ... */}
          ...
          <div className="lg:col-span-2">
            {/* 2. Replace the hardcoded form with your new Client Component! */}
            <ContactForm />
          </div>
